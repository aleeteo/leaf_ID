function results = test_classify_multiple(classifier, detector, scaling_data, options)
%TEST_CLASSIFY_MULTIPLE Classifica oggetti in più immagini usando classificatore e riconoscitore.
% Restituisce una tabella con PixelAccuracy e InstanceAccuracy per ogni immagine.
