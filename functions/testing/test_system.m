...
if load_data
  ...
  [training_data, testing_data, scaling_data] = extract_data(classes, unknown_structs, log=true, standardize=true, SaveFlag=false, DoParallel=true);
end
...
test_classify_multiple(classifier, detector, scaling_data, ...
                       ...
                       standardize=true, DoParallel=true, ...
