function full_test(options)
  ...
  fprintf("testing su misc set con maschere segmentate manualmente (GT)\n");
  ...
  fprintf("testing su misc set con maschere segmentate automaticamente\n");
  ...
  fprintf("testing su unknown set con maschere segmentate manualmente (GT)\n");
  test_classify_multiple(classifier, detector, scaling_data, ...
                         directory="dataset/06_unknown_miscs", ...
                         standardize=true, DoParallel=false, ...
                         visualize_predictions=false, ...
                         visualize_confmat=false);
  fprintf("testing su unknown set con maschere segmentate automaticamente\n");
  test_classify_image(classifier, detector, scaling_data, ...
                      directory="dataset/06_unknown_miscs", ...
                      standardize=true, doparallel=false, ...
                      visualize_predictions=false, ...
